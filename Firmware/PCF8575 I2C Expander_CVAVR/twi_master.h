...
****************************************************************************/
#define TWI_BUFFER_SIZE 25   // Set this to the largest message size that will be sent including address byte.

#define TWI_TWBR            0x20        // TWI Bit rate Register setting.     32 dec = 20H
                                        // Se Application note for detailed 
                                        // information on setting this value.  8MhZ clk scl freq 100khz
// Not used defines!
